...
class SS_ConvNeXt(nn.Module):
    def __init__(self, num_classes: int = 4, depths: list = [1, 1, 2, 1], dims: list = [64, 96, 64, 96], 
        ...
        layer1 = nn.Sequential(nn.Conv2d(num_channels, dims[0], kernel_size=1, stride=1, padding=0, bias=False),
        ...
        self.ln = LayerNorm(dims[3], eps=1e-6, data_format="channels_first")
